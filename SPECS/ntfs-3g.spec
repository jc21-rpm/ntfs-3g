...
BuildRequires:  libconfig-devel, libgcrypt-devel, gnutls-devel, libuuid-devel, git, autoconf
Epoch:		2
...
%prep
git clone https://git.code.sf.net/p/ntfs-3g/ntfs-3g ntfs-3g-%{version}
cd ntfs-3g-%{version}
...
%files
%doc ntfs-3g-%{version}/AUTHORS ntfs-3g-%{version}/ChangeLog ntfs-3g-%{version}/CREDITS ntfs-3g-%{version}/NEWS ntfs-3g-%{version}/README
%license ntfs-3g-%{version}/COPYING
%{_sbindir}/mount.ntfs
...
%files -n ntfsprogs
%doc ntfs-3g-%{version}/AUTHORS ntfs-3g-%{version}/CREDITS ntfs-3g-%{version}/ChangeLog ntfs-3g-%{version}/NEWS ntfs-3g-%{version}/README
%license ntfs-3g-%{version}/COPYING
%{_bindir}/ntfscat
%{_bindir}/ntfscluster
%{_bindir}/ntfscmp
